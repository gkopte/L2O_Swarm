...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        pbounds = {'c1': (0, 2), 'c2': (0, 2), 'b': (0, 1)}

        # Define the fitness function
        def objective(c1, c2, b):
            ...
            model.train()
            return -tf.reduce_mean(model.f_p)

        # Create a Bayesian optimizer object
        ...
        # Print the optimal values of c1, c2, and b
        print(optimizer.max)
